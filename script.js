...
const projectData = [
  {
    ...
    title: "OSCA SPENDS",
    description:
      "SPENDS (Social Pension Network for DSWD Seniors) is our capstone project developed for the Office of the Senior Citizens Affairs (OSCA) in North Caloocan. It is a blockchain-integrated web system built using PHP, Laravel, Node.js, Alpine.js, JavaScript, Tailwind CSS, MySQL, and Ganache for local blockchain simulation. The system securely manages and verifies senior citizen records. By storing verified data on the blockchain, it ensures data integrity, prevents fraudulent activity, and supports accurate tracking of qualified beneficiaries. SPENDS also includes a login throttle system to prevent brute-force or spam login attempts. Additionally, it features SMS notifications through the Semaphore API, which automatically notifies senior citizens about the status of their application as a beneficiary.",
    images: [
  ...
  },
  {
    ...
    description:
      "The Document Request System is a web-based application developed as part of our project for Amparo High School to streamline the process of requesting official school documents. Built using PHP, HTML/CSS, JavaScript, Bootstrap, and MySQL, the system allows students and parents to easily request records such as diplomas, Form 137/138, and certificates of good moral character. It also features a notification system to keep users updated on the status of their requests, a comment system for communication between users and the registrar, and document upload functionality for submitting necessary requirements. These features help the registrar efficiently manage, verify, and track all requests in one centralized platform.",
    images: [
